  ...
  return (
    ...
    >
      ...
      <div style={{ width: "70em" }}>
        ...
        <p>
          As a Web Developer and Project Manager for C&S Mailing I work with a
          group of designers to deliver high quality websites for ecommerce
          brands, politicians, rental complexes, and other companies. My main
          tasks included communicating with the client about their needs,
          setting up the work order for the team and facilitating due dates,
          setting up frontend and backend coding, and setting up backend
          marketing programs.
        </p>
        ...
        <p>
          ...
          ecommerce clients gets prepped, boxed, and shipped properly to the
          customer. I check for any quality control errors on the products being
          shipped, and ensure the correct products are being fulfilled quickly.
          I also helped create inventory management for the products we have in
          our warehouse.
        </p>
        ...
        <p>
          ...
          information from callers and getting that information to our patrol
          officers, detectives, and other varying law enforcement officials.
        </p>
        <h4>Children's Treehouse Learning Center - Assistant Teacher</h4>
        <h5>January 2016 - July 2016</h5>
        <p>
          Assisted the lead teacher with kids aged 1.5 years - 3 years. Also
          promoted to lead teacher for the Art enrichment program for kids aged
          1 to 5 years.
        </p>
        <h4>Derby Dining Center - Supervisor</h4>
        <h5>August 2011 - December 2015</h5>
        <p>
          Led team of kitchen staff of 20+ employees in set up, serving, and
          clean up through each major serving time at dining center on campus.
        </p>
        <h4>Wheatstate Pizza - Manager</h4>
        <h5>July 2014 - December 2015</h5>
        <p>
          Led team of 15 employees through day to day business of a pizzeria.
          While there I was an opening manager and closing manager depending on
          the day. Opening the store required me to set up cash tills for
          employees and start the process of making food for the day. Closing
          entailed balance cash tills and creating deposits for the banks, as
          well as cleaning and preparing for the next day.
        </p>
      </div>
    </div>
  );
